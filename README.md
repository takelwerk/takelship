...
Be careful with comments in the :
```
...
When you edit the configuration in `takelship/compose` then this key must be set or your config will be overwritten after the next restart:
