...
def test_takel_ship_services_compose_dirs_service_dir(host, testvars):
...
def test_takel_ship_services_compose_dirs_service_dirs(host, testvars):
    user = testvars['takel_ship_services_user']['owner']
    group = testvars['takel_ship_services_user']['group']
    home_dir = testvars['takel_ship_services_home_dir']
    data_dir = testvars['takel_ship_services_dist_dir']
...
def test_takel_ship_services_compose_dirs_volumes(host, testvars):
    user = testvars['takel_ship_services_user']['owner']
    group = testvars['takel_ship_services_user']['group']
    home_dir = testvars['takel_ship_services_home_dir']
    data_dir = testvars['takel_ship_services_dist_dir']
