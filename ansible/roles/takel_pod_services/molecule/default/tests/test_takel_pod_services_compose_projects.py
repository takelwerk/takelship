...
def test_takel_pod_services_compose_projects_compose_files(host, testvars):
    ...
    projects = testvars['takel_pod_services_projects']
...
def test_takel_pod_services_compose_projects_bash_files(host, testvars):
    user = testvars['takel_pod_services_user']['owner']
    group = testvars['takel_pod_services_user']['group']
    home_dir = testvars['takel_pod_services_home_dir']
    dist_dir = testvars['takel_pod_services_dist_dir']
