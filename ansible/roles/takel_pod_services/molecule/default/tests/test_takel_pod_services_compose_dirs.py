...
def test_takel_pod_services_compose_dirs_service_dir(host, testvars):
    ...
    data_dir = testvars['takel_pod_services_dist_dir']
...
def test_takel_pod_services_compose_dirs_service_dirs(host, testvars):
    user = testvars['takel_pod_services_user']['owner']
    group = testvars['takel_pod_services_user']['group']
    home_dir = testvars['takel_pod_services_home_dir']
    data_dir = testvars['takel_pod_services_dist_dir']
...
def test_takel_pod_services_compose_dirs_volumes(host, testvars):
    user = testvars['takel_pod_services_user']['owner']
    group = testvars['takel_pod_services_user']['group']
    home_dir = testvars['takel_pod_services_home_dir']
    data_dir = testvars['takel_pod_services_dist_dir']
